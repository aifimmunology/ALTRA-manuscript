...
antigens = {
    "total_t_cells": ["CD56","HLA-DR","CD27","CD38","CD197 (CCR7)","CD45RA","CD127 (IL7Ra)"
,"CD25 (IL2Ra)","CD4","CD8","abTCR"],
    "total_myeloid_cells": ["CD14","HLA-DR","CD45RA","CD11b","CD11c","CD123 (IL3Ra)","CD141","CD15","CD16","CD304" ],
    "total_b_cells": ["CD19","HLA-DR","CD27","CD38","CD25 (IL2Ra)","IgD","CD11c","CD123 (IL3Ra)","CD16"],
    "Other cells": ["CD27","CD38","CD197 (CCR7)","CD45RA","CD127 (IL7Ra)","CD25 (IL2Ra)","CD11b","CD11c","CD123 (IL3Ra)","CD34"]
}
...
keys_to_subset = ['Other cells', 'total_b_cells', 'total_myeloid_cells']
...
for label, sub_adata in subset_data.items():
    ...
    for res in leiden_res: 
        p1 = sy.plot.umap(sub_adata, color= res ,return_fig = True, size = .5, ncols = 3,legend_loc="on data")
        p1.savefig(leiden_fig_path + label   + "_umap_" + res + "_" +panel + ".png",dpi=400, bbox_inches='tight')
